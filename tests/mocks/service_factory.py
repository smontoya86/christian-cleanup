...
class MockServiceFactory:
    ...
    @classmethod
    def create_spotify_service(cls, test_data: Optional[Dict[str, Any]] = None,
                              network_simulator: Optional[NetworkConditionSimulator] = None,
                              **kwargs) -> 'MockSpotifyService':
        """
    ...
    @classmethod
    def create_genius_service(cls, test_data: Optional[Dict[str, Any]] = None,
                             network_simulator: Optional[NetworkConditionSimulator] = None,
                             **kwargs) -> 'MockGeniusService':
        """
    ...
    @classmethod
    def create_analysis_service(cls, test_data: Optional[Dict[str, Any]] = None,
                               network_simulator: Optional[NetworkConditionSimulator] = None,
                               **kwargs) -> 'MockAnalysisService':
        """
