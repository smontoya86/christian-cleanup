...
class MockAnalysisService(BaseMockService):
    ...
    def analyze_song(self, song_id: int, lyrics: Optional[str] = None, 
                    title: Optional[str] = None, artist: Optional[str] = None) -> MockAnalysisResult:
        """
        ...
        """
        self._simulate_network_call('analyze_song', song_id=song_id, 
                                   lyrics=lyrics, title=title, artist=artist)
    ...
    def detect_christian_themes(self, text: str) -> MockChristianThemeResult:
        ...
        # Simple mock logic based on text content
        christian_words = ['jesus', 'christ', 'god', 'lord', 'savior', 'faith', 'worship', 'praise', 'hallelujah']
...
class MockUnifiedAnalysisService:
    ...
    def enqueue_analysis_job(self, song_id: int, user_id: Optional[int] = None, 
...
def create_mock_analysis_result(song_id: int = 1, safe: bool = True, **kwargs) -> MockAnalysisResult:
