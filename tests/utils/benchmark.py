...
class PerformanceBenchmark:
    ...
    def _calculate_stats(self, execution_times: List[float], memory_usages: List[float]) -> Dict[str, Any]:
        """
...
def compare_benchmarks(benchmark_name: str, results_dir: str = None) -> Dict[str, Any]:
    ...
    time_change = ((latest['execution_time']['mean'] - previous['execution_time']['mean']) 
                   / previous['execution_time']['mean'] * 100)
    ...
    if previous['memory_usage']['mean'] == 0:
        ...
        memory_change = ((latest['memory_usage']['mean'] - previous['memory_usage']['mean']) 
                         / previous['memory_usage']['mean'] * 100)
