...
class RegressionDetector:
    ...
    def detect_regressions(self) -> List[Dict[str, Any]]:
        ...
        for name, results in benchmarks.items():
            ...
            memory_regression = self._check_metric_regression(
                latest["memory_usage"]["mean"], previous["memory_usage"]["mean"], "memory_usage"
            )
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        most_problematic = sorted(regression_counts.items(), key=lambda x: x[1], reverse=True)[:5]
        ...
        return {
            ...
            "summary": {
                ...
                "regression_rate": benchmarks_with_regressions / total_benchmarks
    ...
    def _group_results_by_benchmark(
    ...
    def _check_metric_regression(
        self, current: float, previous: float, metric_name: str
