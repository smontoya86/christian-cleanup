    ...
    def test_database_session_management_regression(self, app, db_session):
        ...
        with app.app_context():
            try:
                ...
                saved_user = db_session.query(User).filter_by(spotify_id='session_test_user').first()
    ...
    def test_song_lyrics_update_race_condition_regression(self, app, db_session):
        ...
        with app.app_context():
            try:
                ...
                # Verify update
                updated_song = db_session.query(Song).filter_by(spotify_id='test_song_race_condition').first()
    ...
    def test_analysis_result_aggregation_regression(self, app, db_session, test_user):
        ...
        with app.app_context():
            try:
                ...
                avg_score = db_session.query(func.avg(AnalysisResult.score)).filter(
                    AnalysisResult.status == AnalysisResult.STATUS_COMPLETED
                ).scalar()
    ...
    def test_transaction_rollback_regression(self, app, db_session):
        ...
        with app.app_context():
            try:
                ...
                user_exists = db_session.query(User).filter_by(spotify_id='test_rollback_user').first()
