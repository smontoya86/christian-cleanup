...
class TestConnectionPooling:
    ...
    def test_concurrent_database_access(self):
        ...
        def query_database(thread_id):
            ...
            try:
                ...
                return {"thread_id": thread_id, "song_count": 0, "success": False, "error": str(e)}
        ...
        if success_rate >= 0.7:  # At least 70% success rate is acceptable for SQLite
            ...
            unexpected_failures = [
                r for r in failed_queries if not r.get("expected_failure", False)
            ]
    ...
    def test_connection_recycling(self):
        ...
        ), "No connections should be checked out after closing"
    ...
    def test_connection_timeout_handling(self):
        ...
        assert (
            connection_time < 5.0
        ), f"Connection should be established quickly, took {connection_time:.2f}s"
