...
class TestSuccessResponse:
    ...
    def test_success_response_with_meta(self, app):
        ...
        with app.app_context():
            ...
            response, status_code = success_response(data={"users": []}, meta=meta)
    ...
    def test_success_response_custom_status_code(self, app):
        ...
        with app.app_context():
            response, status_code = success_response(
                data={"id": 123}, message="Resource created", status_code=201
            )
...
class TestErrorResponse:
    ...
    def test_basic_error_response(self, app):
        ...
        with app.app_context():
            response, status_code = error_response(400, "Invalid input provided", "ValidationError")
    ...
    def test_error_response_with_details_in_debug(self, app):
        ...
        with app.app_context():
            ...
            response, status_code = error_response(400, "Validation failed", details=details)
    ...
    def test_error_response_no_details_in_production(self, app):
        ...
        try:
            ...
            with app.app_context():
                ...
                response, status_code = error_response(500, "Internal error", details=details)
    ...
    def test_error_response_with_custom_ids(self, app):
        ...
        with app.app_context():
            ...
            response, status_code = error_response(
                404, "Not found", error_id=error_id, request_id=request_id
            )
...
class TestValidationError:
    ...
    def test_validation_error_with_string_errors(self, app):
        ...
        with app.app_context():
            response, status_code = validation_error("Email is required", field="email")
...
class TestNotFoundError:
    ...
    def test_not_found_error_custom_message(self, app):
        ...
        with app.app_context():
            ...
            response, status_code = not_found_error("Playlist", "abc123", message=custom_message)
...
class TestUnauthorizedError:
    ...
    def test_unauthorized_error_custom(self, app):
        ...
        with app.app_context():
            response, status_code = unauthorized_error(
                message="Valid API key required", auth_type="api_key"
            )
...
class TestForbiddenError:
    ...
    def test_forbidden_error_with_permission(self, app):
        ...
        with app.app_context():
            response, status_code = forbidden_error(
                message="Admin access required", required_permission="admin.read"
            )
...
class TestRateLimitError:
    ...
    def test_rate_limit_error_with_details(self, app):
        ...
        with app.app_context():
            response, status_code = rate_limit_error(
                message="Too many API calls", retry_after=60, limit=100, remaining=0
            )
    ...
    def test_server_error_with_traceback_in_debug(self, app):
        ...
        with app.app_context():
            ...
            with patch("app.utils.api_responses.logger"):
                response, status_code = server_error(exception, include_traceback=True)
    ...
    def test_timeout_error_custom_message(self, app):
        ...
        with app.app_context():
            response, status_code = timeout_error(
                "API call", 15.0, message="The request took too long to complete"
            )
