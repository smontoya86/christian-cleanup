...
class TestPlaylistAPI:
    ...
    @pytest.mark.api
    def test_get_playlists_returns_user_data(self, client, authenticated_user, sample_playlist, sample_song, sample_user):
    ...
    @pytest.mark.api
    def test_get_playlist_songs_requires_ownership(self, client, authenticated_user, other_user_playlist, sample_user):
    ...
    @pytest.mark.api
    def test_get_playlist_songs_returns_song_data(self, client, authenticated_user, sample_playlist, sample_song, sample_user):
        """Test that playlist songs endpoint returns detailed song and analysis data."""
        from app.models.models import PlaylistSong, AnalysisResult
...
class TestSongAnalysisAPI:
    ...
    @pytest.mark.api
    def test_get_song_analysis_requires_ownership(self, client, authenticated_user, other_user_song, sample_user):
    ...
    @pytest.mark.api
    def test_get_song_analysis_returns_detailed_data(self, client, authenticated_user, sample_playlist, sample_song, sample_user):
    ...
    @pytest.mark.api
    def test_get_song_analysis_handles_no_analysis(self, client, authenticated_user, sample_playlist, sample_song, sample_user):
...
class TestProgressAPI:
    ...
    @pytest.mark.api
    def test_get_analysis_progress_requires_ownership(self, client, authenticated_user, other_user_playlist, sample_user):
    ...
    @pytest.mark.api
    def test_get_analysis_progress_calculates_correctly(self, client, authenticated_user, sample_playlist, sample_user):
        """Test that progress endpoint correctly calculates analysis progress."""
        from app.models.models import Song, PlaylistSong, AnalysisResult
...
class TestSearchAPI:
    ...
    @pytest.mark.api
    def test_search_songs_returns_matching_results(self, client, authenticated_user, sample_playlist, sample_song, sample_user):
