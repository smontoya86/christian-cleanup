...
# Mock imports
from tests.mocks.analysis_mocks import MockAnalysisResult, MockSongAnalyzer
    ...
    with app.app_context():
        ...
        analysis = AnalysisResult(
            ...
            supporting_scripture=[
                {"reference": "Ephesians 2:8-9", "text": "For by grace you have been saved..."}
            ],
        )
...
def mock_anthropic():
    ...
    with patch("anthropic.Anthropic") as mock_anthropic:
        ...
        mock_response.content = [
            Mock(
                text='{"christian_score": 8.5, "themes": "salvation, grace", "explanation": "Test analysis"}'
            )
        ]
...
def mock_external_apis():
    ...
    with responses.RequestsMock() as rsps:
        ...
        rsps.add(
            ...
            json={"id": "test_user", "display_name": "Test User", "email": "test@example.com"},
            status=200,
        )
...
class TestDataFactory:
    ...
    @staticmethod
    def create_spotify_track_data(
        track_id="test_track_123", name="Test Song", artist="Test Artist"
    ):
...
def other_user_song(app, db, other_user, other_user_playlist):
    ...
    from app.models.models import PlaylistSong, Song

    song = Song(spotify_id="other_song_999", title="Other User Song", artist="Other Artist")
    ...
    playlist_song = PlaylistSong(
        playlist_id=other_user_playlist.id, song_id=song.id, track_position=0
    )
...
def auto_patch_analysis(request):
        ...
        return DualAccessResult(
            {
                ...
                "artist": artist,
                "content_flags": {"safe": True, "inappropriate": False},
                "themes_detected": ["christian", "worship"]
                if is_christian_content
                else ["general"],
                "final_score": mock_score,
    ...
    try:
        ...
        if hasattr(app.utils.analysis, "SongAnalyzer"):
            patches.append(
                patch("app.utils.analysis.SongAnalyzer", return_value=mock_song_analyzer)
            )
