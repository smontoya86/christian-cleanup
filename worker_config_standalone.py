"""
Standalone worker configuration for RQ (Redis Queue) with platform-specific optimizations.
This module doesn't depend on Flask app imports to avoid initialization issues.
"""
