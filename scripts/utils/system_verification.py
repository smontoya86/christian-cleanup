...
def test_analysis_service():
    ...
    try:
        ...
        with app.app_context():
            ...
            analysis_count = AnalysisResult.query.count()
            recent_analysis = AnalysisResult.query.order_by(
            ...
            if recent_analysis:
                ...
                logger.info("   📊 No analysis results found - system ready for first analysis")
    ...
    try:
        ...
        with app.app_context():
            ...
            if correlation_id and len(correlation_id) > 0:
                logger.info("   ✅ Correlation ID generation working")

            # Test error response creation
            error_response = create_error_response(
                message="Test error", error_type="test_error", status_code=400
            )
    ...
    try:
        ...
        with app.app_context():
            ...
            if user.access_token:
                logger.info("   ✅ User has access token")
                ...
                logger.warning(
                    f"   ⚠️  User {user.display_name} has no access token - service ready for OAuth"
                )
