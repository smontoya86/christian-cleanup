...
class ContextualThemeDetector:
        ...
        self.theme_patterns = {
            ...
            "jesus": {
                "patterns": [
                    ...
                    r"\bLamb of God\b",
                    r"\bSon of God\b",
                    r"\bPrince of Peace\b",
                    r"\bLord Jesus\b",
                    r"\bJesus Christ\b",
                    r"\bImmanuel\b",
                    r"\bEmmanuel\b",
                    r"\bWonderful Counselor\b",
                    r"\bMighty God\b",
                    r"\bSon of Man\b",
                    r"\bWord\b",
                    r"\bLogos\b",
            ...
            "sanctification": {
                "patterns": [
                    ...
                    r"\bset apart\b",
                    r"\bconsecrat\w*\b",
                    r"\bspiritual growth\b",
                    r"\bbecoming like Christ\b",
                    r"\btransform\w*\b",
                ],
            ...
            "judgment": {
                "patterns": [
                    ...
                    r"\btribunal\b",
                    r"\baccountable\b",
                    r"\bday of reckoning\b",
                    r"\bfinal judgment\b",
                    r"\bjust.*God\b",
                    r"\brighteous.*judge\b",
                ],
            ...
            "thanksgiving": {
                "patterns": [
                    ...
                    r"\bblessing\b",
                    r"\bbless\w*\b",
                    r"\bpraise.*goodness\b",
                    r"\bcount.*blessings\b",
                ],
    ...
    def detect_themes_with_context(
        self, lyrics: str, sentiment_data: Dict, emotion_data: Dict
    ) -> List[Dict]:
        """
    ...
    def _detect_semantic_themes(
        ...
        try:
            ...
            christian_results = self.semantic_classifier(
                lyrics, self.semantic_christian_themes, multi_label=True
            )

            # Analyze concerning themes
            concerning_results = self.semantic_classifier(
                lyrics, self.semantic_concerning_themes, multi_label=True
            )
    ...
    def _validate_pattern_context(
        self, theme_name: str, phrases: List[str], sentiment_data: Dict, emotion_data: Dict
    ) -> Dict:
        ...
        # Default validation
        result = {"validated": True, "multiplier": 1.0, "context": "neutral"}
        ...
        if theme_name in ["god", "jesus"] and any(
            word in phrase.lower() for phrase in phrases for word in ["damn", "cursing"]
        ):
    ...
    def _deduplicate_themes(self, themes: List[Dict]) -> List[Dict]:
        ...
        for theme in themes:
            ...
            if (
                theme_name not in theme_map
                or theme["confidence"] > theme_map[theme_name]["confidence"]
            ):
