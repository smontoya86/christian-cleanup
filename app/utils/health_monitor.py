...
class HealthMonitor:
    ...
    def get_system_health(self, force_refresh: bool = False) -> SystemHealth:
        ...
        if (
            ...
            and (now - self._last_check_time).total_seconds() < self._cache_ttl
        ):
        ...
        system_health = SystemHealth(
            status=overall_status, timestamp=now, checks=checks, summary=summary
        )
    ...
    def _check_priority_queue(self) -> HealthCheck:
        ...
        try:
            ...
            # Queue system removed - return default values
            queue_size = 0
            worker_count = 0
            processing_jobs = 0
    ...
    def _check_worker_status(self) -> HealthCheck:
        ...
        try:
            ...
            processing_jobs = db.session.execute(
            ...
            return HealthCheck(
                ...
                message=message,
                timestamp=datetime.now(timezone.utc),
                details={"processing_jobs": processing_jobs},
            )
    ...
    def _check_external_apis(self) -> HealthCheck:
        ...
        try:
            ...
            try:
                ...
                spotify_status = (
                    "available" if response.status_code in [200, 401] else "unavailable"
                )
            except:
            ...
            return HealthCheck(
                ...
                message=message,
                timestamp=datetime.now(timezone.utc),
                details={"spotify_api": spotify_status},
            )
