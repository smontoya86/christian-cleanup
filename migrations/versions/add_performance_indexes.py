...
def upgrade():
    ...
    op.create_index('idx_analysis_results_song_id_perf', 'analysis_results', ['song_id'], unique=False)
    op.create_index('idx_analysis_results_status_perf', 'analysis_results', ['status'], unique=False)
    op.create_index('idx_analysis_results_analyzed_at_perf', 'analysis_results', [sa.text('analyzed_at DESC')], unique=False)
    op.create_index('idx_analysis_results_composite_perf', 'analysis_results', ['song_id', 'status'], unique=False)
...
def downgrade():
    ...
    op.drop_index('idx_analysis_results_composite_perf', table_name='analysis_results')
    op.drop_index('idx_analysis_results_analyzed_at_perf', table_name='analysis_results')
    op.drop_index('idx_analysis_results_status_perf', table_name='analysis_results')
    op.drop_index('idx_analysis_results_song_id_perf', table_name='analysis_results')
